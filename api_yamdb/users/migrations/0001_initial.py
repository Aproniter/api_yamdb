    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('father_name', models.CharField(blank=True, max_length=80, verbose_name='Отчество')),
                ('confirmation_code', models.CharField(default='0000', max_length=4, null=True, verbose_name='Код подтверждения')),
